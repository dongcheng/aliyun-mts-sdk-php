...
//$result = $mtsClient->submitMediaInfoJob(json_encode(['Bucket'=>'wanhaohuo','Location'=>'oss-cn-hangzhou','Object'=>'demo/3874309.mp4']),'1da35aa09b4d4d5db4317d8cece1d971');
//$result = $mtsClient->queryMediaInfoJobList('3b6d1404f1fd4c31a9260e579ab04b2f,c7176722ea1f462eb7bb5e510ff0b11b');
//$result = $mtsClient->submitAnalysisJob(json_encode(['Bucket'=>'wanhaohuo','Location'=>'oss-cn-hangzhou','Object'=>'demo/mtv1.mp4']),'1da35aa09b4d4d5db4317d8cece1d971' );
...
//$result = $mtsClient->submitSnapshotJob(json_encode(['Bucket'=>'wanhaohuo','Location'=>'oss-cn-hangzhou','Object'=>'demo/3874309.mp4']), json_encode(['OutputFile'=>['Bucket'=>'wanhaohuo','Location'=>'oss-cn-hangzhou','Object'=>'demo/3874309_snapshot_{Count}.jpg'],'Time'=>5,'Num'=>5,'Interval'=>20]), '1da35aa09b4d4d5db4317d8cece1d971');
...
//    json_encode(['Bucket'=>'wanhaohuo','Location'=>'oss-cn-hangzhou','Object'=>'demo/mtv1.mp4']),
//    'wanhaohuo',
//    'oss-cn-hangzhou',
//    json_encode([
//        [
...
//        ]
//    ]),
//    '1da35aa09b4d4d5db4317d8cece1d971'
//);
